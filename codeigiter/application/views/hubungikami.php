...
<head>
      ...
      <!--CSSLINK-->
	  <link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/css/hubungikami.css"); ?>">
	  <link rel="stylesheet" type="text/css" href="<?php echo base_url("assets/css/hf.css"); ?>">
      <!--nav-->
    ...
    ******************************************************************************************************************-->
	...
	<content>
		...
		<div class="sixteen columns clearfix collection_nav">
 			<h1 class="collection_title">Hubungi Kami</h1>
		</div>
		<form method="post" action="/contact#contact_form" id="contact_form" accept-charset="UTF-8" class="contact-form">
			<input type="hidden" name="form_type" value="contact" />
			<input type="hidden" name="utf8" value="✓" />
			<h2>
				Punya pertanyaan, saran atau ingin menyapa kami, silahkan isi detail di bawah dan tim kami akan sesegera mungkin membalas email anda.
			</h2>
			<table style="width: 100%;">
				<tr>
			<th><div class="enam">
				<iframe width="100%" height="340" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=embed&amp;hl=en&amp;geocode=&amp;q=Jalan+Abdul+Majid+Dalam+3+South+Cipete,+Cilandak&amp;z=15&amp;output=embed"></iframe>
			</div></th>
  			<th><div class="empat">
  				<div class="row">
  					<div class="col">
      				<label for="contactFormName" style="font-weight: bold;">Name <span class="red">*</span></label>
      				<br class="clear" />
      				<input type="text" id="contactFormName" name="contact[contact-form-name]" placeholder="Name" autocapitalize="words" value="" required="required">
    				</div>
    				<div class="col">
      				<label for="contactFormEmail" style="font-weight: bold;">Email <span class="red">*</span></label>
      				<br class="clear" />
      				<input type="email" id="contactFormEmail" name="contact[email]" placeholder="Email" autocorrect="off" autocapitalize="off" value="" required="required">
    				</div>
    			</div>
				<label for="contactFormMessage" style="font-weight: bold;">Message <span class="red">*</span></label>
				<br class="clear" />
              ...
              <div class="container">
                ...
                <div class="col">
                  ...
                  <ul class="footer_menu">
                    <li><a href=""<?php echo base_url("halaman/hubungi"); ?>">CONTACT US</a></li>
                    <li><a href="<?php echo base_url("halaman/lifetime"); ?>">LIFETIME WARRANTY</a></li>
